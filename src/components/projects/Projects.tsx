...
import { selectArchivedProjects, selectCurrentProjects } from '../../features/projects/selectors';
    ...
    <div>
      <div style={{ display: 'flex' }}>
        ...
        <ButtonGroup>
          ...
          <IconButton onClick={() => setShowProjectAnalytics(true)} variant="outline-primary" Icon={PieChart} />
        </ButtonGroup>
      </div>
